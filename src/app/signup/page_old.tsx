...
import { Eye, EyeOff, Key, Mail, Lock, UserPlus, ArrowLeft, CheckCircle, AlertCircle, Gift, Clock } from 'lucide-react';
import { createUserWithAutoTrial, createUserWithAccessCode } from '@/lib/auth';
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // シークレットキーまたは自動体験での登録
      const result = await createUserWithAutoTrial(
        formData.email,
        formData.password,
